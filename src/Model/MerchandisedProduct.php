...
class MerchandisedProduct extends AbstractModel
{
     ...
     * use this value in the Browse API <b>search</b> method to retrieve items for this
     * product.
     *
     * @var string
     */
    ...
    /**
     * An array of containers for ratings of the product aspects, such as "Is it a good
     * value".
     *
